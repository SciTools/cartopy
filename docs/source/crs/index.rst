...
The :class:`~cartopy.crs.Globe` class is used to encapsulate the underlying spheroid or ellipsoid of any cartopy CRS.
All CRS's have an associated :class:`~cartopy.crs.Globe`, though often it is just the default :class:`~cartopy.crs.Globe`
