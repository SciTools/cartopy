...
class Test_LambertConformal_standard_parallels:
    ...
    def test_single_spole(self):
        ...
        assert_array_almost_equal(s_pole_crs.x_limits, (-19939660, 19939660), decimal=0)
        assert_array_almost_equal(
            s_pole_crs.y_limits, (-735590302, -8183795), decimal=0
        )

    def test_single_npole(self):
        n_pole_crs = ccrs.LambertConformal(standard_parallels=[1.0])
        assert_array_almost_equal(n_pole_crs.x_limits, (-20130569, 20130569), decimal=0)
        assert_array_almost_equal(n_pole_crs.y_limits, (-8170229, 726200683), decimal=0)
