...
@pytest.mark.mpl_image_compare(
    tolerance=0.97 if MPL_VERSION.release[:2] < (3, 5) else 0.5, style="mpl20"
)
...
@pytest.mark.natural_earth
@pytest.mark.mpl_image_compare(
    filename="pcolormesh_limited_area_wrap.png", tolerance=1.82
)
