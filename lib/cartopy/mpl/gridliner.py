...
class _Gridline_Base():
    ...
    def change_gridline_tick_decimal_separator(self, 
        ...
        if axis.lower() == 'both':
            ...
            self.xformatter = ticker.FuncFormatter(lambda x, y : custom_tick_func_formatter(x, y))
            self.yformatter = ticker.FuncFormatter(lambda x, y : custom_tick_func_formatter(x, y))
...
class Gridliner(_Gridline_Base):
