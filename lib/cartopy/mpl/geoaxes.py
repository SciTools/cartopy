...
class GeoAxes(matplotlib.axes.Axes):
    ...
    def nightshade(self, date, delta=0.1, refraction=-0.83,
        ...
        """
        from ._solar import solar_position
        ...
        return self.fill(x, y, color=color, alpha=alpha,
                         transform=rotated_pole, **kwargs)
