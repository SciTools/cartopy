...
def _ring_is_ccw(ring):
    ...
    - when a projected polygon spans exactly ±180° longitude and the boundary
      attachment creates a degenerate "tail"

    - some contours generated by contourpy
      https://github.com/contourpy/contourpy/issues/377

    The shoelace sum dot(x[:-1], y[1:]) - dot(x[1:], y[:-1])
...
class Projection(CRS, metaclass=ABCMeta):
    ...
    def _project_polygon(self, polygon, src_crs):
        ...
        if src_crs.is_geodetic():
            ...
            is_ccw = _ring_is_ccw(polygon.exterior)
